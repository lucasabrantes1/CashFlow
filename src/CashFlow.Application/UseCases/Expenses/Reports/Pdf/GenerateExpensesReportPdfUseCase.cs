...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        foreach (var expense in expenses)
        {
            ...
            row.Cells[0].Format.Font = new Font { Name = FontHelper.WORK_SANS_REGULAR, Size = 12, Color = ColorsHelper.BLACK};
            ...
            row.Cells[1].Format.Font = new Font { Name = FontHelper.WORK_SANS_REGULAR, Size = 12, Color = ColorsHelper.BLACK };
            row.Cells[1].Shading.Color = ColorsHelper.GREEN_DARK;
            row.Cells[1].VerticalAlignment = VerticalAlignment.Center;


            row.Cells[3].AddParagraph($"-{expense.Amount} {CURRENCY_SYMBOL}");
            row.Cells[3].Format.Font = new Font { Name = FontHelper.WORK_SANS_REGULAR, Size = 14, Color = ColorsHelper.BLACK };
